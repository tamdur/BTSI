function [A,xAll,sigY,t,outDat] = runevalchain_22_10_25(valM,oM,colLabels,obsPrior)
...
%Internal settings for the chain script
...
satOnly=1;%1 to ignore proxy data and only use satellites (no drift calculation), 0 otherwise
...
[H0, Hsig, T0, th0] = getar2priorseval(NN,oindex,tindex,sindex,iObs,colLabels,obsPrior);
...
outDat.proxy3cycle=proxy3cycle;outDat.satOnly=satOnly;
