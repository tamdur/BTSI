...
oTSI(2).datetime = datejd(TSIcomposite.julian_date);

[mthVal,mthDate] = dailytomonthly(TSIcomposite.julian_date,TSIcomposite.TSIc);
mthVal2 = dailytomonthly(TSIcomposite.julian_date,TSIcomposite.dTSIc);
...
%Read NRLTSI2
tsi = ncread('nrltsi2_accessed_22_7_19.nc','TSI');
time = datetime(1610,1,1+ncread('nrltsi2_accessed_22_7_19.nc','time'));
oTSI(4).product = 'NRLTSI2';
oTSI(4).path = 'nrltsi2_accessed_22_7_19.nc';
oTSI(4).version = 'v02r01';
oTSI(4).mthtsi = tsi;
oTSI(4).mthtsiUnc=ncread('nrltsi2_accessed_22_7_19.nc','TSI_UNC');
...
oTSI(5).path = 'satire_accessed_22_10_27.txt';
...
oTSI(7).path='2238-1_MergedPMOD_NobaselineScaleCycle23_JPM_b_16022022_accessed_22_07_13.txt';
...
importROB
oTSI(8).product='ROB';
oTSI(8).path='ROB_TSI_accessed_22_09_15.txt';
oTSI(9).source='https://www.sidc.be/observations/tsi';
...
oTSI(9).path='TSI_Composite-SIST_accessed_22_09_20.txt';
oTSI(9).source='https://spot.colorado.edu/~koppg/TSI/TSI_Composite-SIST.txt';
oTSI(9).version='2022_06_10';
...
oTSI(10).version = '1.1';
oTSI(10).tsi = TSIcomposite.TSIo;
oTSI(10).tsiUnc = TSIcomposite.dTSIo;
oTSI(10).datetime = datejd(TSIcomposite.julian_date);
