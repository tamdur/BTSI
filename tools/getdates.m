...
dateS.allinitialsubmit = [juliandate(datetime(1978,11,1)) juliandate(datetime(2021,12,31))];
dateS.all = [juliandate(datetime(1978,11,1)) juliandate(datetime(2024,8,31))];
end